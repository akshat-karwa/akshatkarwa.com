...
export default function About() {
  return (
      ...
      >
      <div className="flex flex-col lg:flex-row items-center lg:items-center gap-6 lg:gap-16 max-w-7xl relative w-full pt-8 md:pt-12">
        {/* Responsive sizes for all devices */}
        <div className="relative w-60 h-60 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-[350px] lg:h-[350px] rounded-full overflow-hidden 
        shadow-lg border-8 border-black flex-shrink-0 mt-4 md:mt-6 ml-8 lg:ml-12">
          <Image
        ...
        <div className="bg-white/90 backdrop-blur-sm p-6 sm:p-8 rounded-lg shadow-lg w-full max-w-3xl lg:max-w-4xl border-8 border-black">
