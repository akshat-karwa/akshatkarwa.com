...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      {Object.entries(groupedProjects).map(([sectionTitle, sectionProjects]) => (
        <div key={sectionTitle} className="w-full mb-16">
          <h3 className="text-lg sm:text-xl font-semibold text-left text-black mb-6 px-8">
            {sectionTitle}
          </h3>
          <div className="w-full max-w-[1800px] mx-auto px-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 justify-items-center">
            {sectionProjects.map((project) => (
              <Link
                ...
                className="group flex justify-center transform transition-all duration-300 hover:-translate-y-1"
              >
                <div className="bg-neutral-50 p-6 rounded-2xl shadow-sm border-2 border-black w-[480px] h-[480px] flex flex-col justify-start hover:shadow-md">
